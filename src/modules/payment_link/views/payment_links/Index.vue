                ...
                <tr>
                  ...
                  <td>
                    <div class="table-custom__flex">
                      <div class="dot-status" :class="item.status === 'Activo' ? 'dot-status--success' : 'dot-status--disable'
                        "></div>
                      {{ item.status }}
                    </div>
                  </td>
                  ...
                  <td>
                    <div class="table-custom__center" @click="isOpen = true">
                      <img class="share" :src="getFile({route:'icons', url:'save', extension:'svg'})" alt="" />
                    </div>
                  </td>
                </tr>
              </tbody>
      ...
      <div class="modal__content" v-if="step === 1">
        ...
        <div class="tabs__modal">
          ...
          >
            ...
            <v-tab value="two"><span class="t-btn">{{ $t('paymentsLink.email') }} </span></v-tab>
          </v-tabs>

          <v-window v-model="tab">
            <v-window-item value="one">
              <img :src="getFile({route: 'images', url: 'qr', extension:'svg'})" alt="" />
              <label for="email">{{ $t('paymentsLink.copyShare') }}</label><br>
            ...
            <v-window-item value="two">
              <label for="email">{{ $t('paymentsLink.shareByEmail')  }}</label><br>
              ...
              <v-btn color="primary" class="w-100 mt-5 py-3 px-4" @click="step = 2">{{ $t('send') }}</v-btn>
            </v-window-item>
          </v-window>
        </div>
      </div>
