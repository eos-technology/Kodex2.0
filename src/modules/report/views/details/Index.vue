        ...
        <v-card class="pa-6">
            <div class="d-flex align-center justify-space-between">
                ...
                <div class="filter d-flex align-center">
                    <router-link style="text-decoration: none;" class="text-black" :to="{ name: 'send_report' }">
                        <v-btn class="text-none ml-4 font-weight-bold primary outlined" variant="outlined">{{ $t('reports.sendReport') }}</v-btn>
                    </router-link>
                    <v-btn class="text-none ml-4 font-weight-bold text-white primary" color="#091D8B">{{ $t('reports.sendDownload') }}</v-btn>
                </div>
            </div>
            <!-- desktop view (table) -->
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-center">
                                    <div class="dot-status mr-2" :class="(item.status) === 'Aprovada' ? 'bg-success' : (item.status) === 'Cancelado' ? 'bg-red' : 'bg-yellow'
                                        "></div>
                        ...
                        <div class="card-custom__content">
                            ...
                            <div class="card-custom__item">
                                ...
                                <div class="dot-status"
                                    :class="(item.status) === 'Aprovada' ? 'bg-success' : (item.status) === 'Cancelado' ? 'bg-danger' : 'bg-warning'">
                                </div>
                                <p>
                                {{ item.status }}
                                </p>
