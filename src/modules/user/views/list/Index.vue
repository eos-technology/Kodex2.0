    ...
    <section class="users">
        <div class="d-flex align-center justify-space-between">
            ...
            <router-link :to="{ name: 'create-user' }">
                <v-btn color="#091D8B" class="text-none text-white primary">{{ $t('users.btnUser') }}</v-btn>
            </router-link>
        </div>
        <v-card class="pa-6">
            <div class="d-flex">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="users__box">
                                    <div class="dot-status" :class="(item.status) === 'Aprovada' ? 'bg-success' : (item.status) === 'Cancelada' ? 'bg-red' : 'bg-yellow'
                                        "></div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-custom__content">
                            ...
                            <div class="card-custom__item">
                                <p>{{ $t("user.status") }}</p>
                                <div class="users__box">
                                    <div class="dot-status" :class="(item.status) === 'Aprovada' ? 'bg-success' : (item.status) === 'Cancelada' ? 'bg-danger' : 'bg-warning'
                                        "></div>
                                    <p>{{ item.status }}</p>
                                </div>
                            </div>
