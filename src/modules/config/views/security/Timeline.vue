...
const data = [
    ...
    },
    {
        ...
        comment: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex laborum quasi ullam atque consequuntur. Doloribus mollitia rem incidunt veritatis impedit omnis architecto ipsum, saepe qui rerum commodi ipsa laudantium quibusdam? Obcaecati distinctio necessitatibus ducimus voluptates.',
        img: '@/assets/images/chat.png',
    },
    {
        username: 'user5',
...
const shortDate = (date: any) => {
    ...
    return `${dateTime.toLocaleDateString('es-ES', dateOptions)} ${dateTime.toLocaleTimeString('es-ES', timeOptions)}`
}

</script> 

<style lang='scss' scoped> .filter {
     display: grid;
