                ...
                <div class="verify-api__header">
                    ...
                    <div class="api-status">
                        <p>
                            ...
                            {{ $t('setting.verificaton-process') }}
                        </p>
                    </div>
                </div>

                <div class="verify-api__content mt-4">
                    <p class="b-regular">{{ $t('setting.verification-code') }}</p>
                    <v-text-field :placeholder="$t('setting.code')" variant="solo" class="rounded-lg"></v-text-field>
                    <p class="b-regular message">{{ $t('settings.email-code') }} example@email.com</p>
                </div>

                <div class="verify-api__buttons mt-8">
...
<style lang='scss' scoped> .verify-api {
     &__header {
         display: flex;
         flex-direction: row;
