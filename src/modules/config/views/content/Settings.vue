            ...
            <div class="setting-section">
                ...
                <div v-if="selected == 1" class="account-settings">
                    <div class="row-setting">
                        ...
                        <router-link :to="{ name: 'account' }" class="b-regular"
                    ...
                    <div class="account-settings__group">
                        ...
                        <div class="row-setting">
                            <p>{{ $t('setting.state') }}</p>
                            <p>
                                <span class="dot-status dot-status--in-process"></span>&nbsp;
                        ...
                        <div class="row-setting">
                            ...
                            <p>
                                <span class="dot-status dot-status--disable"></span>&nbsp;
                                Deshabilitado
                            </p>
                        </div>
                        <div class="row-setting">
                    ...
                    <div class="account-settings__hook">
                        <form>
                            <div class="from-input">
                                <label for="hook">Web Hook</label>
                                <input type="text" name="Hook" placeholder="Web Hook Link">
                                <p>{{ $t('setting.hook-message') }}</p>
                            </div>
                            <div class="form-button">
                                <v-btn class="primary outlined-add text-none">{{ $t('setting.test-connection') }}</v-btn>
                            </div>
                        </form>
                ...
                <div v-if="selected == 3" class="api-settings">
                    ...
                    <div class="api-settings__header">
                        ...
                        <router-link :to="{ name: 'keys' }">
                            <v-btn class="text-none text-white primary" color="#091D8B">{{ $t('setting.new-api') }}</v-btn>
                        </router-link>
                    </div>
                ...
                <div v-if="selected == 4" class="verification-settings">
                    ...
                    <div class="verification-settings__section">
                        ...
                        <p class="b-regular">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum consequuntur
                            cumque hic incidunt. Cumque iure nemo veniam porro magnam, vitae harum, ipsa quis esse voluptas
                            eius exercitationem possimus tempora beatae.</p>
                    ...
                    <div class="verification-settings__download">
                        ...
                        <v-btn class="text-none primary outlined" variant="outlined">{{
                            $t('setting.validate-view-document') }}</v-btn>
                    </div>
                </div>
...
<style lang='scss' scoped> .setting-section {
     display: flex;
